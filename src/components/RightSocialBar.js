...
const RightSocialBar = () => (
  <div className="fixed top-1/2 right-4 z-50 -translate-y-1/2 flex flex-col gap-4">
    <div className="glass-card backdrop-blur-glass bg-f1-black/60 p-3 flex flex-col items-center gap-4 shadow-lg">
      {socials.map((s) => (
        <a
          key={s.name}
          href={s.url}
